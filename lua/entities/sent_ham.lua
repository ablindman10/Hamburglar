...
ENT.PrintName = "Steamed Ham"
ENT.Author = "Some chode"
ENT.Information = "You call them steamed hams despite the fact they're obviously grilled"
...
local BounceSound = Sound( "garrysmod/memed_hams.wav" )
...
local matBall = Material( "sprites/sent_ham" )
